...
<div class="main_div">
     ...
     <div class="navbar navbar-expand-md">
      ...
      <a href="#" class="navbar-brand font-weight-bold text-white text-center">INTERNATIONAL BANK</a>
...
?> 
                    ...
                    <div class="card-body"style="margin-top:0px;background-color:rgb(54, 127, 175);border-radius:10px;color:white">
          ...
          <div class="col-sm-4">
              <div class="card text-center" style="margin-top:60px;height:380px;background-color: rgb(30, 21, 61);">
                   <div class="card-body">
          ...
          <div class="col-sm-4">
                <div class="card text-center" style="margin-top:76px;background-color:rgb(54, 127, 175);border-radius:10px;color:white">
